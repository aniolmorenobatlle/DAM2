package dam.amoreno.exemple_validacio_interna.programa;

import dam.amoreno.exemple_validacio_interna.principal.*;
...
public class ProgramaAmbValidacioInterna {
	...
	public static void main(String[] args) {
		...
		Model = palamos.comprovarModel("Konika","Minolta");
