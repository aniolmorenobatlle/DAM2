...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun restaurants() {
        ...
        val restaurant4 = Mapes(1, "Restaurant", "L'arbre de Juliette", 41.8462, 3.1307)
    ...
    private fun instituts() {
        ...
        val institut3 = Mapes(3, "Institut", "Institut Públic Empordà", 41.8521, 3.1231)
        val marker3 = mMap.addMarker(MarkerOptions()
        ...
        val institut4 = Mapes(3, "Institut", "Institut Secundaria", 41.8531, 3.1254)
        val marker4 = mMap.addMarker(MarkerOptions()
