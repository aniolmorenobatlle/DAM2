package com.example.exemplefirebase_v2
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            // TODO : generar un formulari que permeti introduir un nou contacte (id, nom, població i posició -long, lat-) a la base de dades
