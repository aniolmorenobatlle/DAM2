...
public class Ex1 {
        ...
        try {
            ...
            while (true) {
                ...
                switch (opcio) {
                    ...
                    case 3:
                        System.out.print("Introdueix la consulta XQuery: ");
                        String xquery = sc.nextLine();
    ...
    private static void executeXQuery(String xquery) throws XMLDBException {
        System.out.print("Introdueix el nom de la col·lecció a la qual fer la consulta4: ");
        String collectionPath = sc.nextLine();
